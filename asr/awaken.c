...
int run_ivw(const char *grammar_list, const char* audio_filename ,  const char* session_begin_params)
{
...
{
	int         ret       = MSP_SUCCESS;
	const char *lgi_param = "appid = 595c9d5c,engine_start = ivw,ivw_res_path =fo|res/ivw/wakeupresource.jet, work_dir = ."; //使用唤醒需要在此设置engine_start = ivw,ivw_res_path =fo|xxx/xx 启动唤醒引擎
